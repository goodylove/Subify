...
export default function SignIn() {
  ...
  const canSubmit = isValidEmail(emailAddress) && isValidPassword(password) && !isBusy;
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const { error: finalizeError } = await signInFlow.finalize({
      ...
      >
        ...
        >
          ...
          <View className="mt-10 items-center">
            <Text className="font-sans-extrabold text-3xl text-primary">Welcome back</Text>
            ...
            <View className="gap-4">
              ...
              >
                {isSubmitting ? (
                  ...
                  <Text className="font-sans-bold text-base text-white">Sign in</Text>
                )}
              </TouchableOpacity>
              ...
              <View className="mt-3 flex-row items-center justify-center gap-1">
                ...
                <Link href="/(auth)/sign-up" asChild>
                  <TouchableOpacity>
                    <Text className="font-sans-bold text-sm text-accent">Create an account</Text>
                  </TouchableOpacity>
                </Link>
              </View>
            </View>
          ...
          <Text className="mt-6 text-center font-sans-medium text-xs text-primary/50">
            Your credentials are encrypted and securely stored on your device.
          </Text>
        </ScrollView>
      </KeyboardAvoidingView>
    </SafeAreaView>
